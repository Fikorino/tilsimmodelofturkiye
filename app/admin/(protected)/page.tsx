      ...
      <div className="mx-auto max-w-6xl px-4 py-10 md:px-6">
        ...
        <Tabs defaultValue={searchParams.tab ?? "site"} className="mt-8">
          <TabsList className="flex flex-wrap">
            ...
            <TabsTrigger value="forms">Başvuru Metinleri</TabsTrigger>
          ...
          <TabsContent value="site">
            <section className="glass rounded-2xl p-6">
              ...
              >
                ...
                <div className="grid gap-2">
                  <Label>Domain</Label>
                  <Input name="domain" defaultValue={siteSettings?.domain ?? "tilsimmodelofturkiye.com"} />
                </div>
                <div className="grid gap-2">
                ...
                <label className="flex items-center gap-3 text-sm">
                  ...
                  <span>Sadece logo göster (site başlığını gizle)</span>
                </label>
            ...
            <section className="glass rounded-2xl p-6">
              ...
              <div className="mt-6 grid gap-4">
                {timelineItems?.map((item: any) => (
                  <form key={item.id} action={updateTimelineItem} className="grid gap-3 md:grid-cols-4">
                    ...
                    <Textarea name="description" defaultValue={item.description} className="md:col-span-4" />
                  </form>
                ))}
              </div>
            </section>
          ...
          <TabsContent value="jury">
            <section className="glass rounded-2xl p-6">
              ...
              >
                ...
                <Input name="website" placeholder="Web sitesi" />
                <Button type="submit">Ekle</Button>
              </form>
              <div className="mt-6 grid gap-4">
                {juryMembers?.map((member: any) => (
                  ...
                  >
                    ...
                    <Input name="linkedin" defaultValue={member.socials?.linkedin ?? ""} />
                    <Input name="website" defaultValue={member.socials?.website ?? ""} />
                    <div className="flex gap-2">
                      <Button type="submit" size="sm">
                        Güncelle
                      </Button>
                      <Button type="submit" formAction={deleteJuryMember} variant="outline" size="sm">
                        Sil
                      </Button>
                    </div>
                  </form>
              ...
              <section className="glass rounded-2xl p-6">
                ...
                <div className="mt-6 grid gap-4">
                  {sponsorPackages?.map((item: any) => (
                    <form key={item.id} action={updateSponsorPackage} className="grid gap-3 md:grid-cols-4">
                      <input type="hidden" name="id" value={item.id} />
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button type="submit" formAction={deleteSponsorPackage} variant="outline" size="sm">
                          Sil
                        </Button>
                      </div>
                      <Textarea name="description" defaultValue={item.description} className="md:col-span-4" />
              ...
              <section className="glass rounded-2xl p-6">
                ...
                <div className="mt-6 grid gap-4">
                  {sponsorLogos?.map((item: any) => (
                    <form key={item.id} action={deleteSponsorLogo} className="flex items-center justify-between">
                      <div>
              ...
              <form action={upsertAppContent} className="mt-6 grid gap-6">
                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    ...
                    <Input
                      name="labelContestantDogumTarihi"
                      defaultValue={appContent.labels?.contestant?.dogumTarihi}
                    />
                    ...
                    <Input
                      name="labelContestantInstagramUrl"
                      defaultValue={appContent.labels?.contestant?.instagramUrl}
                    />
                    <Input
                      name="labelContestantTiktokUrl"
                      defaultValue={appContent.labels?.contestant?.tiktokUrl}
                    />
                    <Input
                      name="labelContestantKendiniTanit"
                      defaultValue={appContent.labels?.contestant?.kendiniTanit}
                    />
                    <Input
                      name="labelContestantVesikalikFoto"
                      defaultValue={appContent.labels?.contestant?.vesikalikFoto}
                    />
                    <Input
                      name="labelContestantTamBoyFoto"
                      defaultValue={appContent.labels?.contestant?.tamBoyFoto}
                    />
                    <Input
                      name="labelContestantEkFotograflar"
                      defaultValue={appContent.labels?.contestant?.ekFotograflar}
                    />
                    <Input
                      name="labelContestantTanitimVideosu"
                      defaultValue={appContent.labels?.contestant?.tanitimVideosu}
                    />
                    <Input
                      name="labelContestantOnayBelgesi"
                      defaultValue={appContent.labels?.contestant?.onayBelgesi}
                    />
                  </div>
                </div>
                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    ...
                    <Input
                      name="labelSponsorButceAraligi"
                      defaultValue={appContent.labels?.sponsor?.butceAraligi}
                    />
                    <Input
                      name="labelSponsorPaketler"
                      defaultValue={appContent.labels?.sponsor?.ilgilenilenPaketler}
                    />
                    <Input name="labelSponsorMesaj" defaultValue={appContent.labels?.sponsor?.mesaj} />
                    <Input
                      name="labelSponsorFirmaSunumu"
                      defaultValue={appContent.labels?.sponsor?.firmaSunumu}
                    />
                    <Input
                      name="labelSponsorFirmaLogosu"
                      defaultValue={appContent.labels?.sponsor?.firmaLogosu}
                    />
                  </div>
                </div>
