    ...
    <form className="grid gap-6" onSubmit={onSubmit}>
      <div className="grid gap-4 md:grid-cols-2">
        <div className="grid gap-2">
          <Label htmlFor="adSoyad">{content.labels.contestant.adSoyad}</Label>
        ...
        <div className="grid gap-2">
          <Label htmlFor="dogumTarihi">{content.labels.contestant.dogumTarihi}</Label>
        ...
        <div className="grid gap-2">
          <Label htmlFor="boyCm">{content.labels.contestant.boyCm}</Label>
        ...
        <div className="grid gap-2">
          <Label htmlFor="sehir">{content.labels.contestant.sehir}</Label>
        ...
        <div className="grid gap-2">
          <Label htmlFor="telefon">{content.labels.contestant.telefon}</Label>
        ...
        <div className="grid gap-2">
          <Label htmlFor="eposta">{content.labels.contestant.eposta}</Label>
        ...
        <div className="grid gap-2">
          <Label htmlFor="instagramUrl">{content.labels.contestant.instagramUrl}</Label>
      ...
      <div className="grid gap-2">
        <Label htmlFor="kendiniTanit">{content.labels.contestant.kendiniTanit}</Label>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="grid gap-2">
          <Label htmlFor="vesikalikFoto">{content.labels.contestant.vesikalikFoto}</Label>
          <Input id="vesikalikFoto" name="vesikalikFoto" type="file" accept="image/*" />
        </div>
        <div className="grid gap-2">
          <Label htmlFor="tamBoyFoto">{content.labels.contestant.tamBoyFoto}</Label>
